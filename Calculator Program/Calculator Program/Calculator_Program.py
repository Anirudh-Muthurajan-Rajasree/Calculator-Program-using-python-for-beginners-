...
print("Welcome Anirudh's Calculator Program!")
#Asking the user to type a number
print("kindly enter a number:")
num1 = float(input())#coverting the Datatype from string to float
print("Enter another number:")
num2 = float(input())
#Creating answers for different types of operations
sum = num1 + num2
difference = num1 - num2
product = num1 * num2
quotient = num1 / num2
Exponentiation = num1 ** num2
#Printing th values on the console
